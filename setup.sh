...
# Other
#sudo apt install flatpak qt5-style-plugins furiusisomount timeshift chromium-browser virtualbox virtualbox-guest-additions-iso virtualbox-ext-pack -y
...
sudo snap remove gnome-characters gnome-calculator gnome-system-monitor gnome-logs gnome-system-monitor gtk-common-themes libreoffice -yy
sudo apt install gnome-characters gnome-calculator gnome-system-monitor gnome-logs gnome-system-monitor gtk-common-themes libreoffice -yy
